...
namespace DurakLibrary
{
    ...
    //Класс GameDeck представляет колоду карт для карточной игры, содержащую различные комбинации мастей и рангов.У него есть несколько конструкторов с разными параметрами,
    //    которые позволяют создать колоду разного размера и с различными настройками(например, использование козырей, установка высшей масти и т.д.).
