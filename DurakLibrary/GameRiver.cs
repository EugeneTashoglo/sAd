...
{
    //Класс GameRiver используется для управления картами, добавляемыми и удаляемыми из реки, а также для сравнения карт и возврата строкового представления карт в реке.
